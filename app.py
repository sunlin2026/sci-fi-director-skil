...
- 必须提供 3 个核心画面。
- 每个画面必须按照以下 4 个步骤【严格依次输出】，不允许多输出也不能少输出：

【步骤 1：中文版提示词】
（用详细中文描述主体、环境、景别、光影、风格，并融入已确定的风格流派）

【★ 强制中英同步 ★】：
【步骤 3】的英文提示词，必须严格是【步骤 1】中文提示词的精准翻译，不增减含义，不改变视觉元素。
...
【★ 警告 ★】如果未能在【步骤 2】和【步骤 4】中提供负面提示词，则视为任务失败！
    """
